...
(() => {
  const D = {
    ko: {
      ...
      rank_note: "✓ 표시는 매일 밤 리플레이 검증을 통과한 기록이에요. 한 사람은 모드·난이도마다 최고 기록 하나만 올라가요.",
    ...
    en: {
      ...
      rank_note: "✓ means the score passed the nightly replay check. Each player keeps one best score per mode and difficulty.",
