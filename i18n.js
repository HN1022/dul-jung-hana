...
(() => {
  const D = {
    ko: {
      ...
      rank_all: "전체",
      rank_loading: "불러오는 중…",
      rank_offline: "인터넷에 연결되면 볼 수 있어요",
      rank_empty: "아직 기록이 없어요. 첫 1등이 되어 보세요!",
      rank_verified: "검증된 기록",
      rank_name: "닉네임",
      rank_change: "바꾸기",
      rank_save: "저장",
      rank_name_hint: "2~10자",
      rank_note: "✓ 매일 밤 리플레이 검증을 통과한 기록 · 🛡 구글 연동으로 주인이 확인된 닉네임. 한 사람은 모드·난이도마다 최고 기록 하나만 올라가요.",
      name_err_length: "2~10자로 지어 주세요",
      name_err_chars: "한글, 영문, 숫자, 띄어쓰기, _ - 만 쓸 수 있어요",
      name_err_bad: "다른 닉네임을 써 주세요",
      name_err_taken: "이미 다른 사람이 쓰는 닉네임이에요",
      rank_owned: "구글 연동으로 주인이 확인된 닉네임",
      google_desc: "구글로 연동하면 닉네임이 내 것으로 고정되고(🛡), 폰을 바꿔도 순위표 기록이 이어져요.",
      google_linked: "구글 연동됨 — 닉네임이 내 것으로 고정돼요",
      google_linking: "연동하는 중…",
      google_switched: "이미 연동된 계정으로 들어왔어요. 그 계정의 닉네임과 기록을 이어서 써요.",
      google_err: "연동하지 못했어요. 잠시 뒤에 다시 해 주세요.",
      google_app_later: "구글 연동은 지금은 웹에서만 돼요. 앱은 곧 지원할게요.",
      over_rank: "🏆 순위 보기",
      over_submit: "순위 등록",
      over_sending: "순위표에 올리는 중…",
      over_sent: "순위표에 올렸어요!",
      over_queued: "인터넷이 연결되면 순위표에 올라가요",
      over_unranked: "업데이트 전에 시작한 판이라 순위 등록이 안 돼요",
      over_notbest: "이 순위표의 내 최고 기록보다 낮아요",
      over_need_name: "닉네임을 정하면 순위표에 올라가요",
    ...
    en: {
      ...
      pts: "+{n} pts",
      tricky: "Tricky shape · 1.5× points",
      ...
      rank_offline: "Connect to the internet to see the leaderboard",
      rank_empty: "No scores yet — be the first!",
      rank_verified: "Verified",
      rank_name: "Nickname",
      rank_change: "Change",
      rank_save: "Save",
      rank_name_hint: "2–10 characters",
      rank_note: "✓ passed the nightly replay check · 🛡 nickname owned via Google sign-in. Each player keeps one best score per mode and difficulty.",
      name_err_length: "Use 2–10 characters",
      name_err_chars: "Letters, numbers, spaces, _ and - only",
      name_err_bad: "Please choose a different nickname",
      name_err_taken: "That nickname is already taken",
      rank_owned: "Nickname owned via Google sign-in",
      google_desc: "Link your Google account to lock your nickname (🛡) and keep your leaderboard scores when you change phones.",
      google_linked: "Google linked — your nickname is yours",
      google_linking: "Linking…",
      google_switched: "You signed in to an account that was already linked. Its nickname and scores carry on.",
      google_err: "Couldn't link. Please try again in a moment.",
      google_app_later: "Google sign-in works on the website for now. The app will get it soon.",
      over_rank: "🏆 See ranks",
      over_submit: "Submit",
      over_sending: "Sending your score…",
      over_sent: "Score submitted!",
      over_queued: "It'll be sent when you're online",
      over_unranked: "This game started before the update, so it can't be ranked",
      over_notbest: "Lower than your best on this board",
      over_need_name: "Pick a nickname to join the leaderboard",
