...
(() => {
  const D = {
    ko: {
      ...
      rank_note: "✓ 매일 밤 리플레이 검증을 통과한 기록 · 🛡 구글 연동으로 주인이 확인된 닉네임. 한 사람은 모드·난이도마다 최고 기록 하나만 올라가요. 순위표는 매달 새로 시작하고, 달이 끝나면 순위표마다 상위권에게 칭호를 줘요.",
      season_label: "{y}년 {m}월 시즌",
      season_prev: "지난 시즌",
      season_next: "다음 시즌",
      title_label: "{yy}년 {m}월 {r}등",
      rank_title_pick: "칭호",
      title_none: "안 달기",
      title_err: "칭호를 바꾸지 못했어요",
      ...
      google_btn: "Google로 계속",
      over_rank: "🏆 순위 보기",
      revive_ad: "광고 보고 이어하기",
      revive_free: "이어하기",
      revive_left: "빈칸에 1~3칸을 그려서 계속해요 · 오늘 {n}번 남음",
      step_revive: "<b>🔁</b>빈칸에 1~3칸을 그려서 놓으세요<small>가로·세로로 붙은 모양</small>",
      revive_start: "빈칸을 누르거나 끌어서 1~3칸을 칠하세요",
      revive_count: "{n}칸 — 여기에 놓을까요?",
      revive_place: "여기에 놓기",
      over_submit: "순위 등록",
    ...
    en: {
      ...
      rank_note: "✓ passed the nightly replay check · 🛡 nickname owned via Google sign-in. Each player keeps one best score per mode and difficulty. Leaderboards restart every month, and the top players on each board earn a title.",
      season_label: "{mon} {y} season",
      season_prev: "Previous season",
      season_next: "Next season",
      title_label: "{mon} '{yy} #{r}",
      rank_title_pick: "Title",
      title_none: "None",
      title_err: "Couldn't change your title",
      ...
      over_rank: "🏆 See ranks",
      revive_ad: "Watch an ad to continue",
      revive_free: "Continue",
      revive_left: "Draw 1–3 cells to keep going · {n} left today",
      step_revive: "<b>🔁</b>Draw 1–3 cells on empty spaces<small>they must touch</small>",
      revive_start: "Tap or drag across 1–3 empty cells",
      revive_count: "{n} cells — place here?",
      revive_place: "Place here",
      over_submit: "Submit",
